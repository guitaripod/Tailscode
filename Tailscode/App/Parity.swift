...
enum ParityManifest {
    ...
    static func evidence(for capability: AppCapability) -> ParityEvidence {
        ...
        case .backgroundStop: return .implemented("stopBackgroundWork")
        ...
        case .transcriptNotes: return .implemented("TranscriptNoteCell")
        case .providerRetry: return .implemented("ProviderRetryCell")
        case .conversationRevert: return .implemented("RevertBannerCell")
        ...
        case .delegateBoard: return .implemented("DelegateBoardViewController")
        case .delegateComposer: return .implemented("DelegateComposerViewController")
        ...
        case .openCodeTwoServer: return .implemented("ServerPasswordRule")
        ...
        case .turnEndWhileAway: return .implemented("TurnWaitCenter")
