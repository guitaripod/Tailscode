...
enum ParityManifest {
    ...
    static func evidence(for capability: AppCapability) -> ParityEvidence {
        ...
        case .transcriptNotes: return .implemented("TranscriptNoteLine")
        case .providerRetry: return .implemented("card-retry")
        case .conversationRevert: return .implemented("card-revert")
        ...
        case .delegateBoard: return .implemented("DelegateWindow")
        ...
        case .delegateNotices: return .implemented("raiseDelegate")
        ...
        case .modelEffortPicker: return .implemented("setChosenEffort")
        case .modelEffortDial: return .implemented("ModelDialPopover")
        case .unifiedModelChooser: return .implemented("buildMachines")
        ...
        case .responseStats: return .implemented("response-stats")
        ...
        case .contextWindow: return .implemented("ContextPanel")
        ...
        case .machinePermissions: return .implemented("MachinePermissionsBox")
        case .serverSelfUpdate: return .implemented("UpdateWatch.perform")
        case .serverRestart: return .implemented("confirmRestart")
        case .serverAutoUpdate: return .implemented("UpdateWatch.setAutoUpdate")
        ...
        case .turnEndWhileAway: return .notApplicable("a desktop process is never suspended by the OS while it runs — it keeps its sockets and its event loop open whether or not its window has focus, so the notifier and the status band already say a turn ended the moment it does; the only way this app stops answering is being quit, and a quit process is not somewhere a background wait could wake")
        ...
        case .auroraStream: return .gap("Pango lays the transcript out and Pango can hand over a glyph's rectangle, so the geometry exists here too — but the row is a GtkLabel the toolkit paints, and putting per-glyph quads on it means taking the drawing away from Pango and into the GL area the orb already proves this client can drive. That is a rasteriser, not a wire-up, and until it exists the settled renderer writes every answer on this desk with none of the meaning lost")
        ...
        case .videoPromptHelper: return .implemented("refreshEnhance")
        case .videoLivePreview: return .implemented("adoptSketch")
        case .videoFirstFrame: return .implemented("frameRows")
        case .videoSound: return .implemented("typedSound")
        case .videoEstimate: return .implemented("expectation")
