...
enum ParityManifest {
    ...
    static func evidence(for capability: AppCapability) -> ParityEvidence {
        ...
        case .delegateBoard: return .gap("the delegate window owes a GTK port of DelegateBoard; the words and the folding are already Core's")
        case .delegateComposer: return .gap("the packet dialog owes a GTK form over DelegateDraft and a ladder widget")
        case .delegateRun: return .gap("the run view owes a GTK list over DelegateRunStory.lines and the ladder")
        case .delegateApproval: return .gap("the approve/hold buttons owe a GTK row on the run view")
