...
**Arch** — [tailscode](https://aur.archlinux.org/packages/tailscode) builds the `v1.60` tag; [tailscode-git](https://aur.archlinux.org/packages/tailscode-git) tracks master.
